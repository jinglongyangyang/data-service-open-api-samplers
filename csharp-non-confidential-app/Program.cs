...
namespace UiPath.DataService.Samples
{
    class Program
    {
        ...
        {
            var dataServiceUrl = "https://cloud.uipath.com/entity/IMDB/dataservice_/api";
        ...
        private static async Task<OpenApiAccessToken> GetTokenByUserCredentials(string dataServiceUrl)
        {
            ...
            var tokenProvider = new OpenApiTokenProvider(dataServiceUrl, new OpenApiCredentials()
            {
                ...
                Scope = "DataService.Schema.Read DataService.Data.Read DataService.Data.Write", //Space separated scopes, offline_access is for getting refresh token
            });
